...
$Input_Array['MySQL_Table'] = "FROM Lubricant_Register ";
...
$Dashboard_Array['Title'] = "LUBRICANT REPLACEMENT(S) DASHBOARD";
$Dashboard_Array['Dashboard_Indentifier'] = "D001";
$Dashboard_Array['Item_Link'] = "Lubricant_Record_Item.php";
...
$Dashboard_Array['New_Item_Link_Headings'] = array("Lubricant_Register_ID");
$Dashboard_Array['New_Item_Link_Values'] = array("{$ID}");

$Dashboard_Array['Include_Warnings'] = "No";

$Dashboard_Array['MySQL_Action'] = "SELECT * ";
$Dashboard_Array['MySQL_Table'] = "FROM Lubricant_Record ";
$Dashboard_Array['MySQL_Filter'] = "WHERE `Lubricant Register ID` = '{$ID}' ";
