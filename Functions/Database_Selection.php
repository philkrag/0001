...
// PURPOSE: DETERMINING WHICH DATABASE TO ACCESS
// AUTHOR: PHILLIP KRAGULJAC
// CREATED: 2018-03-29

function Return_Database($From_Statement){
	$Required_Datebase = "User_Data_Collection";
	if($From_Statement=="FROM User_Configuration " || $From_Statement=="FROM User_Details "){$Required_Datebase = "User_Configuration";}
