...
$Dashboard_Array['Title'] = "PREFERRED SUPPLIER(S) DASHBOARD";
$Dashboard_Array['Dashboard_Indentifier'] = "D001";
$Dashboard_Array['Item_Link'] = "Supplier_Register_Item.php";
...
$Dashboard_Array['Column_Headings'] = array("ID", "Company Name"); // Recommended x3 minimum (when images used).
$Dashboard_Array['Displayed_Columns'] = array("ID", "Company Name"); // Recommended x3 minimum (when images used).
...
$Dashboard_Array['MySQL_Table'] = "FROM Supplier_Register ";
