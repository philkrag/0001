...
$Input_Array['Title'] = "WMS(S) REGISTER ITEM";
...
$Dashboard_Array['Title'] = "PROCEDURE(S) DASHBOARD";
$Dashboard_Array['Dashboard_Indentifier'] = "D001";
$Dashboard_Array['Item_Link'] = "Procedure_Record_Item.php";
...
$Dashboard_Array['Column_Headings'] = array("ID", "Step", "Quick Reference"); // Recommended x3 minimum (when images used).
$Dashboard_Array['Displayed_Columns'] = array("ID", "Step", "Quick Reference"); // Recommended x3 minimum (when images used).
$Dashboard_Array['Highlight_Columns'] = array(null, null);

$Dashboard_Array['New_Item_Link_Headings'] = array("WMS_Register_ID");
...
$Dashboard_Array['MySQL_Order'] = "ORDER BY `Step` ASC ";
