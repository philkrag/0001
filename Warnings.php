...
<?php // BASIC DASHBOARD V1.3

$Dashboard_Array['Title'] = "TASKS NEAR DUE";
...
$Dashboard_Array['Column_Headings'] = array("ID", "Fault Description");
$Dashboard_Array['Displayed_Columns'] = array("ID", "Fault Description");
...
$Dashboard_Array['MySQL_Filter'] = "WHERE `Required Completion Date` < DATE(NOW()+INTERVAL 7 DAY) AND `Required Completion Date` > DATE(NOW())";
