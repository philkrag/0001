...
$Dashboard_Array['Title'] = "SUCCESSOR INVESTIGATION(S) REQUIRED DASHBOARD";
...
$Dashboard_Array['Column_Headings'] = array("ID", "Description", "OEM", "OEM Part Type", "OEM Part Number", "OEM Life Cycle Status"); // Recommended x3 minimum (when images used).
$Dashboard_Array['Displayed_Columns'] = array("ID", "Description", "OEM", "OEM Part Type", "OEM Part Number", "OEM Life Cycle Status"); // Recommended x3 minimum (when images used).
...
$Dashboard_Array['MySQL_Filter'] = "WHERE (`Successor Investigation Required` = '' OR `Successor Investigation Required` IS NULL) AND (`Site Recommended Successor` = '' OR `Site Recommended Successor` IS NULL)";
...
$Dashboard_Array['Title'] = "SUITABILITY CHECK(S) REQUIRED DASHBOARD";
...
$Dashboard_Array['MySQL_Action'] = "SELECT * ";
$Dashboard_Array['MySQL_Table'] = "FROM Part_Register ";
$Dashboard_Array['MySQL_Filter'] = "WHERE `Suitability Check Required` = 'Yes' ";
$Dashboard_Array['MySQL_Order'] = "ORDER BY  `ID` ASC ";
$Dashboard_Array['MySQL_Limit'] = "LIMIT {$Dashboard_Array['Dashboard_Limit']} ";
$Dashboard_Array['MySQL_Offset'] = "OFFSET {$Dashboard_Array['Dashboard_Offset']}";
