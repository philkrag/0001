...
$Dashboard_Array['Title'] = "CHEMICAL(S) DASHBOARD";
$Dashboard_Array['Dashboard_Indentifier'] = "D001";
$Dashboard_Array['Item_Link'] = "Chemical_Register_Item.php";
...
$Dashboard_Array['Column_Headings'] = array("ID", "OEM", "OEM Part Number"); // Recommended x3 minimum (when images used).
$Dashboard_Array['Displayed_Columns'] = array("ID", "OEM", "OEM Part Number"); // Recommended x3 minimum (when images used).
...
$Dashboard_Array['MySQL_Table'] = "FROM Chemical_Register ";
