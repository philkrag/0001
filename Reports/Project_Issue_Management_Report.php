...
$Dashboard_Array['Title'] = "ISSUE(S)";

$Dashboard_Array['Column_Headings'] = array("ID", "Description", "Status", "Person Responsible", "Identified Date", "Planned Action Date", "Required Completion Date", "Actual Completion Date"); // Recommended x3 minimum (when images used).
$Dashboard_Array['Displayed_Columns'] = array("ID", "Description", "Status", "Person Responsible", "Identified Date", "Planned Action Date", "Required Completion Date", "Actual Completion Date"); // Recommended x3 minimum (when images used).
$Dashboard_Array['Column_Spacing'] = array("60px", "*", "10%", "20%", "10%", "10%", "10%", "10%");
