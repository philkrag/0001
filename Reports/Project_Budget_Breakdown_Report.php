...
$Dashboard_Array['Column_Headings'] = array("ID", "Task Record ID", "Planned Maintenance Date", "Description", "Estimated Purchase Cost"); // Recommended x3 minimum (when images used).
$Dashboard_Array['Displayed_Columns'] = array("ID", "Task Record ID", "Planned Maintenance Date", "Description", "Estimated Purchase Cost"); // Recommended x3 minimum (when images used).
$Dashboard_Array['Column_Spacing'] = array("60px", "60px", "10%", "*", "10%");
$Dashboard_Array['Highlight_Columns'] = array();
$Dashboard_Array['Sum_Columns'] = array("Estimated Purchase Cost");
...
$Dashboard_Array['Column_Headings'] = array("ID", "Task Record ID", "Classification", "Estimated Hours", "Estimated Minutes"); // Recommended x3 minimum (when images used).
$Dashboard_Array['Displayed_Columns'] = array("ID", "Task Record ID", "Classification", "Estimated Hours", "Estimated Minutes"); // Recommended x3 minimum (when images used).
$Dashboard_Array['Column_Spacing'] = array("60px", "60px", "*", "20%", "20%");
$Dashboard_Array['Highlight_Columns'] = array();
$Dashboard_Array['Sum_Columns'] = array("Estimated Hours", "Estimated Minutes");
...
<tr>
<td class="Report_Main_Sign_Cell">Requested By:</td>
...
<tr>
<td class="Report_Main_Sign_Cell">Authorised By:</td>
<td class="Report_Main_Sign_Cell">Signature:</td>
<td class="Report_Main_Sign_Cell">Date:</td>
</tr>
