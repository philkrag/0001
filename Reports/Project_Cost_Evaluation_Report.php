...
$Input_Array['Title'] = "PROJECT DETAILS";
$Input_Array['ID'] = $ID;
...
$Dashboard_Array['Title'] = "ESTIMATED PARTS(S)";

$Dashboard_Array['Column_Headings'] = array("ID", "Task Record ID", "Planned Maintenance Date", "Description", "Estimated Purchase Cost", "Actual Purchase Cost"); // Recommended x3 minimum (when images used).
$Dashboard_Array['Displayed_Columns'] = array("ID", "Task Record ID", "Planned Maintenance Date", "Description", "Estimated Purchase Cost", "Actual Purchase Cost"); // Recommended x3 minimum (when images used).
$Dashboard_Array['Column_Spacing'] = array("60px", "60px", "10%", "*", "10%", "10%");
$Dashboard_Array['Highlight_Columns'] = array();
$Dashboard_Array['Sum_Columns'] = array("Estimated Purchase Cost", "Actual Purchase Cost");

$Dashboard_Array['MySQL_Action'] = "SELECT * ";
$Dashboard_Array['MySQL_Table'] = "FROM Part_Record ";
$Dashboard_Array['MySQL_Filter'] = "WHERE `ID` IS NOT NULL {$Associated_Tasks_Inset} AND (`Estimated Purchase Cost` != null OR `Estimated Purchase Cost` != '0')";
$Dashboard_Array['MySQL_Order'] = "";
$Dashboard_Array['MySQL_Limit'] = "";
$Dashboard_Array['MySQL_Offset'] = "";
...
$Dashboard_Array['Title'] = "ESTIMATED LABOUR(S)";

$Dashboard_Array['Column_Headings'] = array("ID", "Task Record ID", "Classification", "Estimated Hours", "Estimated Minutes", "Actual Hours", "Actual Minutes"); // Recommended x3 minimum (when images used).
$Dashboard_Array['Displayed_Columns'] = array("ID", "Task Record ID", "Classification", "Estimated Hours", "Estimated Minutes", "Actual Hours", "Actual Minutes"); // Recommended x3 minimum (when images used).
$Dashboard_Array['Column_Spacing'] = array("60px", "60px", "*", "10%", "10%", "10%", "10%");
$Dashboard_Array['Highlight_Columns'] = array();
$Dashboard_Array['Sum_Columns'] = array("Estimated Hours", "Estimated Minutes", "Actual Hours", "Actual Minutes");

$Dashboard_Array['MySQL_Action'] = "SELECT * ";
$Dashboard_Array['MySQL_Table'] = "FROM Labour_Record ";
$Dashboard_Array['MySQL_Filter'] = "WHERE `ID` IS NOT NULL {$Associated_Tasks_Inset} AND (`Estimated Hours` != '0' OR `Estimated Minutes` != '0') ";
$Dashboard_Array['MySQL_Order'] = "";
$Dashboard_Array['MySQL_Limit'] = "";
$Dashboard_Array['MySQL_Offset'] = "";
