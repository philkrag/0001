...
$Dashboard_Array['Title'] = "PROJECT MANAGER(S)";
...
$Dashboard_Array['Column_Spacing'] = array();
...
$Dashboard_Array['MySQL_Filter'] = "WHERE `Project Register ID` = '{$ID}' AND  `Role` = 'Project Manager' ";
...
$Dashboard_Array['Title'] = "CHANGE(S) WAITING APPROVAL";

$Dashboard_Array['Column_Headings'] = array("ID", "Change Description", "Change Impact Rating", "Required Completion Date"); // Recommended x3 minimum (when images used).
$Dashboard_Array['Displayed_Columns'] = array("ID", "Change Description", "Change Impact Rating", "Required Completion Date"); // Recommended x3 minimum (when images used).
...
$Dashboard_Array['MySQL_Filter'] = "WHERE `Project Register ID` = '{$ID}' AND  `Status` = 'Waiting for Approval' ";
$Dashboard_Array['MySQL_Order'] = "ORDER BY `ID` ASC ";
$Dashboard_Array['MySQL_Limit'] = "";
$Dashboard_Array['MySQL_Offset'] = "";
