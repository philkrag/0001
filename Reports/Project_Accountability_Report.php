...
$Dashboard_Array['Column_Headings'] = array("ID", "Task Description", "Contact (Customer)", "Contact (Technician)", "Priority", "Status", "Required Date"); // Recommended x3 minimum (when images used).
$Dashboard_Array['Displayed_Columns'] = array("ID", "Task Description", "Contact (Customer)", "Contact (Technician)", "Priority", "Status", "Required Completion Date"); // Recommended x3 minimum (when images used).
$Dashboard_Array['Column_Spacing'] = array("60px", "*", "20%", "20%", "10%", "10%", "10%");
