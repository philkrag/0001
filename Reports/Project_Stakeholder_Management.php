...
$Dashboard_Array['Column_Headings'] = array("ID", "First Name", "Last Name", "Role", "Desired Support", "Desired Actions", "Phone Preferred", "SMS Preferred", "Email Preferred"); // Recommended x3 minimum (when images used).
$Dashboard_Array['Displayed_Columns'] = array("ID", "First Name", "Last Name", "Role", "Desired Support", "Desired Actions", "Comms via Phone Preferred", "Comms via SMS Preferred", "Comms via Email Preferred"); // Recommended x3 minimum (when images used).
$Dashboard_Array['Column_Spacing'] = array("60px", "15%", "15%", "10%", "15%", "*", "10%", "10%", "10%");
