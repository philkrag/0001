...
$Dashboard_Array['Title'] = "OBJECTIVE(S)";

$Dashboard_Array['Column_Headings'] = array("ID", "Description", "Required Completion Date"); // Recommended x3 minimum (when images used).
$Dashboard_Array['Displayed_Columns'] = array("ID", "Description", "Required Completion Date"); // Recommended x3 minimum (when images used).
$Dashboard_Array['Column_Spacing'] = array();
$Dashboard_Array['Highlight_Columns'] = array();
$Dashboard_Array['Sum_Columns'] = array();
...
$Dashboard_Array['Title'] = "OBSTACLE(S)";
...
$Dashboard_Array['Title'] = "DELIVERABLE(S)";
