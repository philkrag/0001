...
$Dashboard_Array['Title'] = "PERSONNEL RISK DASHBOARD";
...
$Dashboard_Array['Column_Headings'] = array("ID", "Task Description", "Determined Personnel Risk"); // Recommended x3 minimum (when images used).
$Dashboard_Array['Displayed_Columns'] = array("ID", "Task Description", "Determined Personnel Risk"); // Recommended x3 minimum (when images used).
...
$Dashboard_Array['MySQL_Order'] = "ORDER BY FIELD(`Determined Personnel Risk`, '', 'Negligible', 'Minor', 'Moderate', 'Major', 'Critical', 'Fatality') DESC, `Identified Date` ASC ";
...
$Dashboard_Array['Title'] = "EQUIPMENT RISK DASHBOARD";
$Dashboard_Array['Dashboard_Indentifier'] = "D002";
$Dashboard_Array['Item_Link'] = "Task_Record_Item.php";
$Dashboard_Array['Dashboard_Offset'] = Retrieve_Offset($_GET, $Dashboard_Array['Dashboard_Indentifier']); // <<< RESOURCE 0002
$Dashboard_Array['Dashboard_Limit'] = 5;

$Dashboard_Array['Column_Headings'] = array("ID", "Description", "Determined Equipment Risk"); // Recommended x3 minimum (when images used).
$Dashboard_Array['Displayed_Columns'] = array("ID", "Description", "Determined Equipment Risk"); // Recommended x3 minimum (when images used).
$Dashboard_Array['Highlight_Columns'] = array(null, null);
...
$Dashboard_Array['MySQL_Table'] = "FROM Task_Record ";
$Dashboard_Array['MySQL_Filter'] = "WHERE `ID` IS NOT NULL ";
$Dashboard_Array['MySQL_Order'] = "ORDER BY FIELD(`Determined Equipment Risk`, '', 'Negligible', 'Minor', 'Moderate', 'Major', 'Critical') DESC, `Identified Date` ASC ";
$Dashboard_Array['MySQL_Limit'] = "LIMIT {$Dashboard_Array['Dashboard_Limit']} ";
$Dashboard_Array['MySQL_Offset'] = "OFFSET {$Dashboard_Array['Dashboard_Offset']}";
...
$Dashboard_Array['Title'] = "EQUIPMENT ASSIGNED PRIORITIES DASHBOARD";
...
$Dashboard_Array['MySQL_Table'] = "FROM Task_Record ";
$Dashboard_Array['MySQL_Filter'] = "WHERE `ID` IS NOT NULL ";
$Dashboard_Array['MySQL_Order'] = "ORDER BY FIELD(`Priority`, '', 'Within 12 Months', 'Within 6 Months', 'Within 3 Months', 'Within 1 Month', 'Within 2 Weeks', 'Within 1 Week', 'Immediately') DESC, `Identified Date` ASC ";
$Dashboard_Array['MySQL_Limit'] = "LIMIT {$Dashboard_Array['Dashboard_Limit']} ";
$Dashboard_Array['MySQL_Offset'] = "OFFSET {$Dashboard_Array['Dashboard_Offset']}";
