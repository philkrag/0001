...
$Input_Array['Column_Headings'] = array("ID","Name","Manufacturer","Manufacturer Model","Introduced into Service Date","Deleted Date","Last Modified Date","Last Modified Time","Last Modified by User");
$Input_Array['Displayed_Columns'] = array("ID","Name","Manufacturer","Manufacturer Model","Introduced into Service Date","Deleted Date","Last Modified Date","Last Modified Time","Last Modified by User");
