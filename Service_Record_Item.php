...
$Input_Array['Title'] = "SERVICE RECORD(S) ITEM";
...
$Dashboard_Array['Title'] = "COMMENT(S) DASHBOARD";
...
$Dashboard_Array['Column_Headings'] = array("ID", "BT label"); // Recommended x3 minimum (when images used).
...
$Dashboard_Array['New_Item_Link_Headings'] = array("Service_Record_ID");
...
$Dashboard_Array['MySQL_Filter'] = "WHERE `Service Record ID` = '{$ID}' ";
