...
$Input_Array['Title'] = "SERVICE(S) REGISTER ITEM";
...
"Work Method Statement ID",
"Description",
"Service Interval (constant hours)",
"Service Interval (run hours)",
"Due Date (constant hours)",
"Due Date (run hours)",
"Cost (estimated)",
"Labour Hours (estimated)",
"Labour Minutes (estimated)",
"Last Modified Date",
"Last Modified Time",
...
$Input_Array['MySQL_Table'] = "FROM Service_Register ";
...
$Dashboard_Array['Title'] = "SERVICE RECORD(S) DASHBOARD";
$Dashboard_Array['Dashboard_Indentifier'] = "D001";
$Dashboard_Array['Item_Link'] = "Service_Record_Item.php";
...
$Dashboard_Array['Column_Headings'] = array("ID", "Required Completion Date", "Status"); // Recommended x3 minimum (when images used).
$Dashboard_Array['Displayed_Columns'] = array("ID", "Required Completion Date", "Status"); // Recommended x3 minimum (when images used).
$Dashboard_Array['Highlight_Columns'] = array(null, null);

$Dashboard_Array['New_Item_Link_Headings'] = array("Service_Register_ID");
$Dashboard_Array['New_Item_Link_Values'] = array("{$ID}");

$Dashboard_Array['Include_Warnings'] = "No";

$Dashboard_Array['MySQL_Action'] = "SELECT * ";
$Dashboard_Array['MySQL_Table'] = "FROM Service_Record ";
$Dashboard_Array['MySQL_Filter'] = "WHERE `Service Register ID` = '{$ID}' ";
